...
namespace shopOnline.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public List<GioHang> getCart() // Create list cart and save in session 
        {
        ...
        public ActionResult AddToCart(int id, string strURL) //  Add item in cart 
        {
            ...
            GioHang item = listCart.Find(model => model.IdItem == id);
            if (item == null)
            {
                item = new GioHang(id);
                listCart.Add(item);
        ...
        {
            List<GioHang> listCart = getCart();
            GioHang item = listCart.SingleOrDefault(model => model.IdItem == id);
            if (item != null)
            {
